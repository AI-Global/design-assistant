        ...
        return (
            <span>
                ...
                title={
                    ...
                    {this.state.user ? 
                        (this.state.user.role === "admin" || this.state.user.role === "superadmin") ? <DropdownItem onClick={() => this.navAdmin()}><i className="fa fa-database fa-fw"></i> Admin Panel</DropdownItem> : null 
                    : null}
