...
test('Admin can create a new question', async () => {
  ...
  await driver.wait(
    until.elementLocated(
      By.xpath(
        '//*[@id="wb-cont"]/div[1]/div[1]/div/table/thead/tr/th[1]/button'
      )
    )
  );
  await driver
...
test('Admin can edit a question', async () => {
  ...
  await driver.wait(
    until.elementLocated(
      By.xpath(
        '//*[@id="wb-cont"]/div[1]/div[1]/div/table/tbody/tr[1]/td[4]/button'
      )
    )
  );
  await driver
...
test('Admin can create a new Trusted AI Provider', async () => {
  ...
  await driver.wait(
    until.elementLocated(
      By.xpath(
        '/html/body/main/div[1]/div/div/main/div[1]/div[4]/div/table/thead/tr/th[3]/button'
      )
    )
  );
  await driver
...
test('Admin can edit a Trusted AI Provider', async () => {
  ...
  await driver.wait(
    until.elementLocated(
      By.xpath(
        '/html/body/main/div[1]/div/div/main/div[1]/div[4]/div/table/tbody/tr[1]/td[3]/button'
      )
    )
  );
  await driver
...
test('Admin can view Analytics', async () => {
  ...
  await driver.wait(
    until.elementLocated(
      By.xpath('/html/body/main/div[1]/div/div/main/div[1]/div[6]')
    )
  );
  let analytics = await driver.findElement(
    By.xpath('/html/body/main/div[1]/div/div/main/div[1]/div[6]')
  );
...
test('Admin can view list of submissions', async () => {
  ...
  await driver.wait(
    until.elementLocated(
      By.xpath('//*[@id="submissions"]/tbody/tr[1]/td[5]/button')
    )
  );
  let users = await driver.findElement(
    By.xpath('//*[@id="submissions"]/tbody/tr[1]/td[5]/button')
  );
  expect(users).toBeTruthy();
});
...
test('Admin can view a response', async () => {
  ...
  await driver.wait(
    until.elementLocated(
      By.xpath(
        '/html/body/main/div[1]/div/div/main/div[1]/div[3]/div/table/tbody/tr[1]/td[5]/button'
      )
    )
  );
  await driver
