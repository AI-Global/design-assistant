...
test('User can navigate to different dimensions and questions', async () => {
  ...
  await driver.wait(
    until.elementLocated(
      By.xpath(
        "//*[@class='card-header' and contains(text(),'Accountability')]"
      )
    )
  );
  await driver
  ...
  await driver.wait(
    until.elementIsVisible(
      driver.findElement(
        By.xpath(
          '/html/body/main/div[1]/div/div/div[1]/div[1]/div[3]/div[2]/div/button[7]'
        )
      )
    )
  );
  await driver
    .findElement(
      By.xpath(
        '/html/body/main/div[1]/div/div/div[1]/div[1]/div[3]/div[2]/div/button[1]'
      )
    )
    .click();
  await driver
...
test('User can filter by their role, industry, region, lifecycle', async () => {
  ...
  await driver
    .findElement(By.xpath("//*[contains(text(), 'Filters')]"))
    .click();
  await driver.wait(
    until.elementIsVisible(
      driver.findElement(By.xpath("//*[contains(text(), 'Roles')]"))
    )
  );
  ...
  await driver
    .findElement(
      By.xpath(
        '/html/body/main/div[1]/div/div/div[1]/div[2]/div/div[2]/div/div[1]/div/form/div[1]/input'
      )
    )
    .click();
  await driver.findElement(By.xpath("//*[contains(text(), 'Roles')]")).click();
  ...
  await driver
    .findElement(By.xpath("//*[contains(text(), 'Industry')]"))
    .click();
  await driver
    .findElement(
      By.xpath(
        '/html/body/main/div[1]/div/div/div[1]/div[2]/div/div[2]/div/div[2]/div/form/div[1]/input'
      )
    )
    .click();
  await driver
  ...
  await driver
    .findElement(By.xpath("//*[contains(text(), 'Regions')]"))
    .click();
  await driver
    .findElement(
      By.xpath(
        '/html/body/main/div[1]/div/div/div[1]/div[2]/div/div[2]/div/div[3]/div/form/div[1]/input'
      )
    )
    .click();
  await driver
  ...
  await driver
    .findElement(By.xpath("//*[contains(text(), 'Life Cycles')]"))
    .click();
  await driver
    .findElement(
      By.xpath(
        '/html/body/main/div[1]/div/div/div[1]/div[2]/div/div[2]/div/div[4]/div/form/div[1]/input'
      )
    )
    .click();
  await driver
  ...
  await driver
    .findElement(By.xpath("//*[contains(text(), 'Apply Filters')]"))
    .click();
});
...
test('User can finish the survey', async () => {
  ...
  await driver.wait(
    until.elementLocated(By.xpath("//*[contains(text(), 'Finish')]"))
  );
