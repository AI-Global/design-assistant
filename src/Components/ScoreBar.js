...
const BarGraph = (props) => {
  ...
  return <svg version="1.1" viewBox="483 422 389 80" width="389" height="80">
    <defs />
    <g id="BarGraph" fillOpacity="1" strokeOpacity="1" strokeDasharray="none" fill="none" stroke="none">
      ...
      <g id="BarGraph_bargraph">
        ...
        <g id="Graphic_2">
          <rect x={x} y={y} width={barWidth} height="20" fill={barColor} />
        </g>
        <g id="Graphic_5">
          <text transform="translate(488 452.776)" fill={barColor}>
            <tspan fontFamily="Helvetica Neue" fontSize="16" fill={isNaN(score) ? "#e5e5e5" : barColor} x="6394885e-19" y="15">{isNaN(score) ? 'N/A' : score}</tspan>
          </text>
        </g>
      </g>
    </g>
